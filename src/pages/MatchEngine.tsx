...
export default function MatchEngine() {
  ...
  const matchSortOptions = values('match_sort');
                    ...
                    <div className="space-y-6">
                      <div className="flex flex-col sm:flex-row items-center gap-4 justify-between pb-4 border-b border-slate-200">
                        ...
                        <div className="flex items-center gap-3 w-full sm:w-auto">
                          ...
                          >
                            {matchSortOptions.map(option => <option key={option.code} value={option.code.toLowerCase()}>{option.label}</option>)}
                          </select>
                        </div>
                      </div>
      ...
      {showCertModal && previewCv && (
        <CertificationModal
          ...
          onSave={async (newSettings) => {
            ...
            // Save state updates (bulk match generates pseudo-cvs until saved)
