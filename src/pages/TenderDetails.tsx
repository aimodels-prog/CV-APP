          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
            <div>
              ...
              <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-wrap">
                {tender.scope_summary || tender.data?.scope_summary || "No scope summary extracted."}
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {(tender.special_requirements?.length > 0 || tender.data?.special_requirements?.length > 0) ? (
                  (tender.special_requirements || tender.data?.special_requirements).map((req: string, i: number) => (
                      ...
                      <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-slate-600">
                        ...
                        {pos.required_sector_experience && pos.required_sector_experience.length > 0 && (
                          <div className="sm:col-span-2">
                            ...
                            {Array.isArray(pos.required_sector_experience) ? pos.required_sector_experience.join(', ') : pos.required_sector_experience}
                          </div>
                        )}
             ...
             <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-900">{tender.client || tender.data?.client || 'Unknown'}</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-900">{tender.country || tender.data?.country || 'Not specified'}</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-900">
                      {(tender.project_sector?.length > 0 || tender.data?.project_sector?.length > 0) ? (Array.isArray(tender.project_sector || tender.data?.project_sector) ? (tender.project_sector || tender.data?.project_sector).join(', ') : (tender.project_sector || tender.data?.project_sector)) : 'None'}
                    </span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-900">{tender.duration || tender.data?.duration || 'Not specified'}</span>
                  </div>
                </div>
                <div className="flex items-start gap-3">
